...
export function KotakBankPage1({ data }) {
    return (
            ...
            <View style={styles.outerBorder}>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.twoColGrid}>
                        <Text>Report Ref No: KMBL/ {data.referenceNo}</Text>
                        <Text>Date: {data.reportDate}</Text>
                    </View>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.twoColGrid}>
                        <View style={styles.verticalBorder}>
                            <Text style={{ fontWeight: 'bold',fontSize: 12,marginBottom:2 }}>KOTAK MAHINDRA BANK LTD</Text>
                        </View>

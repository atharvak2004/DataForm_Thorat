...
export default function KotakBankReportForm({ onSubmit }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = editMode
        ? `${import.meta.env.VITE_API_URL}/report4/update/${rowIndex}`
        : `${import.meta.env.VITE_API_URL}/report4`;
  ...
  const searchByvehicleNo = async () => {
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL}/report4/find/${searchInput}`);
    ...
    <div className=" p-10 text-xl ">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col space-y-6 bg-gray-50  rounded-xl p-10 max-w-5xl w-full mx-auto border border-gray-300">
        ...
        <span className="flex flex-col space-y-3 text-left p-5 border border-black bg-white">
          ...
          <input className='border border-red-600 rounded-lg p-2' id="makerName" name="makerName" placeholder="makerName" value={formData.makerName} onChange={handleChange} />
        ...
        <span className="flex flex-col space-y-3 text-left p-5 border border-black bg-white">
          <h2 className="text-3xl font-bold mb-5 ">G. ONLINE STATUS:</h2>
        ...
        <span className="flex flex-col space-y-3 text-left p-5 border border-black bg-white">
          <h2 className="text-3xl font-bold mb-5 ">H. CHASSIS NUMBER TRACE/PHOTO</h2>
        ...
        <span className="flex flex-col space-y-3 text-left p-5 border border-black bg-white">
          <h2 className="text-3xl font-bold mb-5 ">J. VEHICLE VALUATION DETAILS</h2>

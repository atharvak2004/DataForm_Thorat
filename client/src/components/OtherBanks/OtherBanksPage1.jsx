...
export function OtherBanksPage1({ data }) {
    return (
        <Page size="A4" style={styles.page}>
            <View style={styles.outerBorder}>
                ...
                <View style={styles.section}>
                    <Text style={styles.sectionHeaderValuation}>VALUATION REPORT</Text>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.twoColGrid}>
                        <View style={styles.verticalBorder}>
                            <Text style={{ fontWeight: 'bold' }}>TO, WHOM IT MAY CONCERN</Text>
                        </View>
                    </View>
                </View>
...
export default OtherBanksPage1;

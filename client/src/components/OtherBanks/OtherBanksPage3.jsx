                ...
                <View style={styles.section}>
                    ...
                    <View style={{}}>
                        {[
                            ...
                            '-  I have no direct or Indirect Interest in the Asset / Vehicle valued.',
                            '-  The information furnished above is true & correct to the best of my knowledge & belief and is sourced from documentation provided, legitimacy of documents provided, to be verified by competent authority. ',
                            '-  This report is issued as per request of the owner/financer of vehicle/asset and is hereby given for Vehicle Loan / other Purpose and it is at the sole discretion of the Bank/ Financier / To whom it may concern, to accept or reject the proposal.'
                        ].map((item, index) => (
...
export default OtherBanksPage3;
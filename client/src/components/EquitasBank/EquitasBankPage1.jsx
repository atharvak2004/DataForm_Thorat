...
export function EquitasBankPage1({ data }) {
    return (
        <Page size="A4" style={styles.page}>
            <View style={styles.outerBorder}>
                ...
                <View style={styles.section}>
                    <Text style={{ fontSize: 10, }}>ESFB VALUATOR EMPANELMENT CODE: VLP0045</Text>
                </View>
                {/* Reference Details */}
                <View style={styles.section}>
                    ...
                    <View style={styles.twoColGrid}>
                        <View style={styles.verticalBorder}>
                            <Text style={{ fontWeight: 'bold', fontSize: 12, marginBottom: 2 }}>Equitas Small Finance Bank Ltd.</Text>
                            <Text >Name of Person Initiated Valuation: MR. {data.initiatedPerson}</Text>
                            <Text >BM or BCM Name & Branch: MR. {data.bmOrBCMName}</Text>
                        </View>
...
export default EquitasBankPage1;

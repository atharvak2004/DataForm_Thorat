  ...
  return (
    <div className=" p-10 text-xl ">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col lg:w-5/12 space-y-3 text-left p-5 bg-slate-200">
        ...
        <label htmlFor="initiatedPerson">Name of Person Initiated Valuation: MR.</label>
        <input className='border border-red-600 rounded-lg p-2' id="initiatedPerson" name="initiatedPerson" placeholder="Name" value={formData.initiatedPerson} onChange={handleChange} />

        <label htmlFor="bmOrBCMName">BM or BCM Name & Branch: MR.</label>
        <input className='border border-red-600 rounded-lg p-2' id="bmOrBCMName" name="bmOrBCMName" placeholder="" value={formData.bmOrBCMName} onChange={handleChange} />
